function HookingMethods(class_name, function_name) {
        var k = ObjC.classes[class_name];
        var impl = k[function_name].implementation;
        console.log("==========================================");
        console.log("==============  Game Start  ==============");

        console.log('Hooking ' + class_name + ' ' + function_name);
        console.log("==========================================");

        Interceptor.attach(impl, {
            onEnter: function(args) {
                console.log("\n========== Enter function "+function_name+" ==========");
...
HookingMethods("ChatSocketCmdHelper","+ getEncryptedData:withSubCommandType:")